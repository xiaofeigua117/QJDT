...
public class OrderUtil01 {

    public static Context contextS;
    public static String fancuoma="";
    public static  String base_data="0000";
    public static  String base_order_out="010607E1000102";
    //餐厅灯
    public static final String open_fan2= "0002";
    public static final String open_fan1= "0001";

    public static final  String menfan_order="FFFC";

    public static final String close_fan="0002";
    ...
    public static void senOrder2(Context contextS,int type){
        ...
        switch (type){
            ...
            case 0:
                ...
                break;
            case 1:
                dataorder=CRC16M.hexString2binaryString(open_fan1);
                dataBitHandl=menfan_order;
                break;
            //主灯2
            case 2:
            ...
            //主灯3：
            case 3:
                dataorder=CRC16M.hexString2binaryString(open_fan2);
                dataBitHandl=menfan_order;
                break;
            case 4:
                //
